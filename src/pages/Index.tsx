...
import romanColosseum1 from "@/assets/roman-colosseum-1.jpg";
import romanPantheon1 from "@/assets/roman-pantheon-1.jpg";
import romanVilla1 from "@/assets/roman-villa-1.jpg";
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="relative animate-fade-in [animation-delay:300ms]">
                <div className="aspect-[4/3] rounded-2xl overflow-hidden">
                  <img 
                    src={romanColosseum1}
                    alt="Majestic Roman Colosseum architecture" 
                ...
                <div className="absolute -bottom-6 -left-6 w-2/3 rounded-2xl overflow-hidden shadow-xl">
                  <img 
                    src={romanPantheon1}
                    alt="Roman Pantheon with magnificent dome" 
                    className="w-full h-full object-cover"
                  />
                </div>
                <div className="absolute -top-6 -right-6 w-1/2 rounded-2xl overflow-hidden shadow-xl">
                  <img 
                    src={romanVilla1}
                    alt="Ancient Roman villa courtyard" 
                    className="w-full h-full object-cover"
                  />
                </div>
              </div>
