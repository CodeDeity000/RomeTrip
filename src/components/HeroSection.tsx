...
import heroRomeImage from "@/assets/hero-rome.jpg";
  ...
  return (
    <section className="relative h-screen overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage: `url(${heroRomeImage})`,
      ...
      >
        <div className="max-w-3xl animate-fade-in">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Button asChild size="lg" variant="default" className="min-w-[200px] rounded-full transform transition-all duration-300 hover:translate-y-[-2px] bg-primary hover:bg-primary/90">
              <Link to="/booking">{t.hero.bookStay}</Link>
            </Button>
            <Button asChild variant="outline" size="lg" className="min-w-[200px] rounded-full transform transition-all duration-300 hover:translate-y-[-2px] border-white/30 text-white hover:bg-white/10">
